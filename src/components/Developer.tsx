...
const Developer = () => {
  return (
    <section id="Developer" className="bg-clr3 font-content text-gray-600">
      <div className="container mx-auto flex flex-col px-5 py-24">
        <div className="mx-auto lg:w-4/6">
          <div className="mt-10 flex flex-col sm:flex-row">
            <div className="text-center sm:w-1/3 sm:py-8 sm:pr-8">
              <div className="inline-flex size-14 items-center justify-center rounded-full bg-gray-200 text-gray-400">
                <img src={DEVICON} alt="Developer Icon" />
              </div>
              <div className="flex flex-col items-center justify-center text-center">
                <h2 className="mt-4 font-title font-medium text-gray-900">Jaelani.dev</h2>
                <div className="mb-4 mt-2 h-1 w-12 rounded bg-yellow-500"></div>
                <p className="text-sm">Mainly work on Web Development, but decided to jump to Game Development</p>
              </div>
            </div>
