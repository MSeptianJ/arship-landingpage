  ...
  return (
    <header className="sticky top-0 font-content">
      <div className="container relative z-10 mx-auto flex items-center justify-between bg-white px-8 py-3 shadow-md md:flex-row md:py-0">
        ...
        <nav className="hidden items-center justify-center text-base md:mx-auto md:flex">
          <a className="w-full p-4 transition-all duration-500 hover:bg-yellow-200" href='#Home'>Home</a>
          <a className="w-full p-4 transition-all duration-500 hover:bg-yellow-200" href='#Feature'>Features</a>
          <a className="w-full p-4 transition-all duration-500 hover:bg-yellow-200" href='#Developer'>Developer</a>
          <a className="w-full p-4 transition-all duration-500 hover:bg-yellow-200" href='#Testimonial'>Testimonial</a>
          <a className="w-full p-4 transition-all duration-500 hover:bg-yellow-200" href='#Contact'>Contacs</a>
        </nav>

        <button onClick={handleClick} className='rounded border-0 bg-accent p-2 text-base transition-colors duration-300 focus:bg-yellow-300 md:hidden'>
          <MenuIcon style={"text-2xl block"}/>
        </button>
      </div>

      <div className={`relative m-auto w-full transition-all duration-500 ease-in-out md:hidden ${toggleNav ? "top-0" : "top-[-300px]"}`}>
