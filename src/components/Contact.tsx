      ...
      <div className="container mx-auto px-5 py-24">
        ...
        <div className="mx-auto md:w-2/3 lg:w-1/2">
          <div className="-m-2 flex flex-wrap">
            ...
            <div className="w-full p-2">
              <button className="mx-auto flex rounded border-0 bg-blue-500 px-8 py-2 text-lg text-white hover:bg-blue-600 focus:outline-none">Button</button>
            </div>
            <div className="mt-8 w-full border-t border-gray-200 p-2 pt-8 text-center">
              <a className="text-blue-500">example@email.com</a>
              <p className="my-5 leading-normal">49 Smith St. Saint Cloud, MN 56301</p>
